...
export default function File() {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={closeFile}>
      <DialogContent className='z-[1000] border-4 border-background bg-foreground text-background rounded-none border-solid p-0 min-w-[50vw] min-h-[50vh] flex flex-col gap-0'>
